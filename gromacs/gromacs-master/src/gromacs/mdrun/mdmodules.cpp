...
public:
    Impl() :
        ...
        colvars_(createColvarsMDModule())
    {
    }
...
void MDModules::subscribeToPreProcessingNotifications()
{
    ...
    impl_->colvars_->subscribeToPreProcessingNotifications(&impl_->notifier_);
}
...
void MDModules::subscribeToSimulationSetupNotifications()
{
    ...
    impl_->colvars_->subscribeToSimulationSetupNotifications(&impl_->notifier_);
}
